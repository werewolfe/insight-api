...
var GENSIS_HASH = '7497ea1b465eb39f1c8f507bc877078fe016d6fcb6dfad3a64c98dcc6e1e8496';
var GENSIS_HASH_TESTNET = '308ea0711d5763be2995670dd9ca9872753561285a84da1d58be58acaa822252';
...
function HistoricSync(opts) {
  ...
  var digibyte        = require('digibyte');
  //digibyte.util.buffer.reverse(genesisHashReversed);
    ...
    self.sync.bDb.getTip(function(err,tip, height) {
      ...
      async.doWhilst(
        ...
        function(err, cb) {
          ...
          console.log('heheheh', ret);
          cb(null, ret);
        },
        function(err, lol) {

          console.log(err, lol, 'he34234234re');
          self.startBlock = tip;
          self.height = height;
          if(height > 1) {
            opts.forceRPC = true;
